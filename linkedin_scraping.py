...
if __name__ == '__main__':
    ...
    # Accept additional "school" filter as input
    search_term = sys.argv[1]
    num_requests = int(sys.argv[2])
    school_filter = sys.argv[3] if len(sys.argv) > 3 else None  # Optional school filter

    # Append school filter to the search term if provided
    if school_filter:
        search_term += f" + '{school_filter}'"

    my_api_key = "AIzaSyAlWnc9-DfqibUiM1SqTXWv18O4jI6oF4M"  # Read readme.md to know how to get you api key
    my_cse_id = "011658049436509675749:gkuaxghjf5u"  # Google CSE which searches LinkedIn profiles
    ...
    for i in range(0, num_requests):
        ...
        for profile in range(0, 10):
            ...
            if "Tesla" in newSnippet or "Tesla" in title:
    ...
    print(f'Output file "{output_fname}" written.')